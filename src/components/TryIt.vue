<template>
  <div
    id="next-section"
    class="bg-white text-[#1A1919] pt-48 md:pb-48 pb-10 max-w-[72rem] xl:max-w-[86%] xl:px-0 px-6 grid lg:grid-cols-2 gap-4 mx-auto"
  >
    <Animate :time="0.3">
    ...
    <div>
      <div class="lg:w-[90%] text-black flex flex-col gap-7 font-medium mt-2 ml-auto">
        <p>
          <Animate :time="0.2">
